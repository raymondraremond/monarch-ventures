...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover the story, vision and values behind Monarch's Mega Ventures Nigeria Limited — a premium Akwa Ibom house of services." },
      { property: "og:title", content: "About Monarch's Mega Ventures" },
      { property: "og:description", content: "A premium Akwa Ibom house of services. Discover our story, vision and team." },
    ],
  }),
  component: AboutPage,
});
    ...
    <>
      <section className="relative h-[60vh] min-h-[420px] -mt-20 overflow-hidden">
        ...
        <div className="relative z-10 container-luxe h-full flex flex-col justify-end pb-16">
          ...
          <h1 className="font-display text-4xl sm:text-5xl md:text-7xl max-w-3xl leading-[1.05]">
            An Akwa Ibom house of <span className="text-gradient-gold italic">premium</span> services.
          </h1>
        </div>
      </section>
      ...
      <section className="container-luxe py-24 grid lg:grid-cols-2 gap-16">
        <div>
          ...
          <div className="mt-8 space-y-5 text-muted-foreground leading-relaxed">
            <p>
              {SITE.legal} began with a simple belief: world-class quality should not be imported. From a single furniture workshop in Etim Ekpo, Monarch's grew into a house of four disciplined divisions — furniture, fishery, piggery and laundry — each obsessing over the same standard.
            </p>
            <p>
              Today, our pieces sit in homes across Akwa Ibom, our fish supplies the region's finest kitchens, our pork feeds restaurants nationwide, and our laundry keeps boutique hotels immaculate.
            </p>
          </div>
        </div>
      ...
      <section className="container-luxe py-24">
        ...
        <div className="mt-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { n: "Mordecai Saturday Enoidem", r: "Founder & CEO" },
