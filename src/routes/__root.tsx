...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Monarch's Mega Ventures Nigeria Limited — Excellence in Every Endeavour" },
      {
        name: "description",
        content:
          "Premium Akwa Ibom conglomerate offering luxury furniture, modern fishery, world-class piggery and elite laundry services across Nigeria.",
      },
      { name: "author", content: "Monarch's Mega Ventures Nigeria Limited" },
      { property: "og:title", content: "Monarch's Mega Ventures Nigeria Limited — Excellence in Every Endeavour" },
      { property: "og:description", content: "A premium, modern website for Monarch's Mega Ventures Nigeria Limited, showcasing luxury furniture, fishery, piggery, and laundry services." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#0B1220" },
      { name: "twitter:title", content: "Monarch's Mega Ventures Nigeria Limited — Excellence in Every Endeavour" },
      { name: "description", content: "A premium, modern website for Monarch's Mega Ventures Nigeria Limited, showcasing luxury furniture, fishery, piggery, and laundry services." },
      { name: "twitter:description", content: "A premium, modern website for Monarch's Mega Ventures Nigeria Limited, showcasing luxury furniture, fishery, piggery, and laundry services." },
